        ...
        {selectedClient ? (
          <ClientDetails clientId={selectedClient._id} />
           ...
           <div className="p-4 flex items-center justify-center h-full">
            <p className="text-gray-500 text-sm">Detalhes do cliente aparecerão aqui.</p>
          </div>
        )}
      </div>
    </div>
